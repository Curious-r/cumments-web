...
```html
<!-- Pinned, reproducible -->
<script type="module" src="https://cumments-web.curious.host/0.5.4/cumments-web.js"></script>
...
* Immutable version: `https://cumments-web.curious.host/0.5.4/cumments-web.js`
