...
```html
<!-- Pinned, reproducible -->
<script type="module" src="https://cumments-web.curious.host/0.5.3/cumments-web.js"></script>
...
* Immutable version: `https://cumments-web.curious.host/0.5.3/cumments-web.js`
